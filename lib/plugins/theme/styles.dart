...
ThemeData appThemeData(AppColors colors, Brightness brightness) {
  return ThemeData(
    ...
    dropdownMenuTheme: DropdownMenuThemeData(
      menuStyle: MenuStyle(
        backgroundColor: MaterialStateProperty.all(colors.card),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      //   vertical: appPadding * 1.7,
      // ),
      // labelStyle: TextStyle(color: colors.text.withOpacity(0.5)),
    ...
    switchTheme: SwitchThemeData(
      ...
      thumbColor: MaterialStateProperty.all(colors.text),
    ),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(color: colors.text.withOpacity(0.1), width: 1.5),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(appBorderRadius),
        ),
        textStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
